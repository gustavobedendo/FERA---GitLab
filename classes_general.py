...
class Ask_for_margins():
    ...
    def __init__(self, patpdf):
        ...
        try:
            ...
            difdriveb = b''
            ...
            self.difdrive = tkinter.PhotoImage(data=difdriveb)
    ...
    def defineMargins(self, tipomargem):
        ...
        try:
            ...
            if(drivepdf!=drivebd):
                ...
                labelask = tkinter.Label(self.window, image=self.difdrive, compound="top", text="Não foi possível adicionar o relatório:"+
                                         "\n\n<{}>\n ao banco de dados:\n <{}>\n\n pois ambos se encontram em partições diferentes! ({} e {})"\
                                             .format(self.pathpdf, global_settings.pathdb, drivepdf, drivebd))
                labelask.grid(row=0, column=0, columnspan=3, sticky='nse', pady=5)
                answer0 = tkinter.Button(self.window, font=global_settings.Font_tuple_Arial_8, text="OK", command=  lambda : window.destroy())
...
class Annotation_Window():
    def __init__(self, observation, annotations, feraapp):
        self.audio_list_formats = [".3gp", ".aac", ".aiff",".amr", ".flac",".m4a", ".mp3",".ogg", ".opus",".ra", ".wav",".wave", ".wma"]
        ...
        self.botaogoogle = tkinter.Button(self.annot_content_frame_buttons, image = self.google, compound='left', text="", command=partial(self.execute_dir))
    ...
    def execute_dir(self):
        ...
        try:
            ...
            self.thread1 = threading.Thread(target=self.executecommands, args=(annotation, filepath,))
            self.thread1.start()
    ...
    def executecommands(self, annotation, filepath):        
        
        try:
            filename, file_extension = os.path.splitext(filepath)            
            output_data = ""
            if file_extension not in [".opus"]:
                output_data = f"Arquivo {self.file.name} desconsiderado"
            else:
