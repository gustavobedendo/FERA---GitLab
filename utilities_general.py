...
def popup_window(texto, sair, imagepcp=None):
    ...
    if(imagepcp!=None):
        label = tkinter.Label(windowpopup, font=global_settings.Font_tuple_Arial_10, text=texto, image=global_settings.imagepcp, compound='top')
    else:
...
def extract_text_from_page(doc, pagina, deslocy, topmargin, bottommargin, leftmargin, rightmargin, flags=2+64, replace_accent = True):
    lowerCodeNoDiff = [ 
      #00-0F #0
